        ...
        <div className="container-custom relative z-10 w-full">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 mb-8">
              <span className="inline-block pl-5 pr-4 py-2 bg-brand-highlight text-[#091b12] text-[10px] font-black uppercase tracking-[0.3em] rounded-full shadow-lg shadow-brand-highlight/20 whitespace-nowrap">
                Conservation Trip
              </span>
            ...
            <p className="text-white/80 text-base font-light max-w-3xl leading-relaxed border-l-2 border-brand-highlight pl-6 py-2">
              Kinabalu Park Sayap is a quieter gateway area of Kinabalu Park, surrounded by cool mountain air, rich rainforest trails, and diverse wildlife. It’s known for its peaceful atmosphere, scenic hikes, and authentic nature experience away from the main tourist crowds.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg md:prose-xl max-w-none text-brand-header/80">
                ...
                <div className="mb-16 grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 min-h-[400px]">
                    <div className="col-span-2 lg:col-span-2 aspect-[4/3] lg:aspect-auto rounded-[2rem] overflow-hidden shadow-sm relative border border-brand-header/5">
                      <img src="https://picsum.photos/seed/sayap1/1000/1200" alt="Wildlife" className="w-full h-full object-cover hover:scale-105 transition-transform duration-[1.5s] ease-out" referrerPolicy="no-referrer" />
                    </div>
                    <div className="col-span-2 lg:col-span-2 grid grid-rows-2 gap-4 md:gap-6">
                      <div className="rounded-[2rem] overflow-hidden shadow-sm relative border border-brand-header/5 min-h-[200px]">
                         <img src="https://picsum.photos/seed/sayap2/1000/600" alt="Homestay detail" className="w-full h-full object-cover hover:scale-105 transition-transform duration-[2s] ease-out" referrerPolicy="no-referrer" />
                      </div>
                      <div className="rounded-[2rem] overflow-hidden shadow-sm relative border border-brand-header/5 min-h-[200px]">
                         <img src="https://picsum.photos/seed/sayap3/1000/600" alt="Nature" className="w-full h-full object-cover hover:scale-105 transition-transform duration-[2s] ease-out" referrerPolicy="no-referrer" />
                      </div>
                    </div>
                </div>
                ...
                <div className="mb-16">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                    <div className="group rounded-[2.5rem] overflow-hidden bg-brand-header border border-[#a7f3d0]/20 shadow-md hover:-translate-y-1 hover:shadow-lg transition-all duration-500 relative flex flex-col">
                      <div className="relative z-10 p-6 md:p-8 text-white flex flex-col justify-between h-full">
                        <div>
                          <div className="w-12 h-12 rounded-[1rem] bg-[#a7f3d0]/10 border border-[#a7f3d0]/20 flex items-center justify-center text-[#a7f3d0] mb-6 transform group-hover:scale-110 transition-transform duration-500 shadow-sm">
                            <MapPin className="w-5 h-5 drop-shadow-sm" />
                          </div>
                          <h4 className="font-serif text-2xl mb-2 m-0 text-white">Night Walks</h4>
                          <p className="text-white/70 text-sm leading-relaxed m-0 font-light mb-6">Spot nocturnal species like the Kinabalu horned frog and glowing fungi with 1StopBorneo.</p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                           <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#FFEA6C] text-[#091b12] text-[10px] font-bold uppercase tracking-widest rounded-full">
                             <Clock className="w-3 h-3" /> 2-3 Hours
                           </span>
                           <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#a7f3d0] text-[#091b12] text-[10px] font-bold uppercase tracking-widest rounded-full">
                             Easy
                           </span>
                        </div>
                      </div>
                    ...
                    <div className="group rounded-[2.5rem] overflow-hidden bg-brand-header border border-[#a7f3d0]/20 shadow-md hover:-translate-y-1 hover:shadow-lg transition-all duration-500 relative flex flex-col">
                      <div className="relative z-10 p-6 md:p-8 text-white flex flex-col justify-between h-full">
                        <div>
                          ...
                          <h4 className="font-serif text-2xl m-0 mb-2 text-white">Minodtuhan Hike</h4>
                          <p className="text-white/70 text-sm leading-relaxed m-0 font-light mb-6">A challenging 12km hike up Mount Minodtuhan (2,345m) for breathtaking views and rare pitcher plants.</p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                           <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-red-400 text-white text-[10px] font-bold uppercase tracking-widest rounded-full">
                             Challenging
                           </span>
                        </div>
                      </div>
                    ...
                    <div className="group rounded-[2.5rem] overflow-hidden bg-brand-header border border-[#a7f3d0]/20 shadow-md hover:-translate-y-1 hover:shadow-lg transition-all duration-500 relative flex flex-col">
                      <div className="relative z-10 p-6 md:p-8 text-white flex flex-col justify-between h-full">
                        <div>
                          ...
                          <h4 className="font-serif text-2xl m-0 mb-2 text-white">Jungle Camping</h4>
                          <p className="text-white/70 text-sm leading-relaxed m-0 font-light mb-6">Scenic campsite that can get chilly due to the elevation. Perfect for true nature lovers seeking silence.</p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                           <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white text-[#091b12] text-[10px] font-bold uppercase tracking-widest rounded-full">
                             Overnight
                           </span>
                        </div>
                      </div>
