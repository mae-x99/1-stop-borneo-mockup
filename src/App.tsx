      ...
      <main className="flex-grow">
        ...
        <section className="py-24 relative bg-white overflow-hidden">
          ...
          <div 
            ...
            style={{ 
              backgroundImage: 'linear-gradient(#0A2515 1px, transparent 1px), linear-gradient(90deg, #0A2515 1px, transparent 1px)',
          ...
          <div className="container-custom max-w-7xl mx-auto relative z-10">
            ...
            <div className="relative overflow-hidden">
              <div className="text-center max-w-4xl mx-auto mb-16 lg:mb-24">
                ...
                <h2 className="text-5xl md:text-6xl lg:text-7xl font-serif text-brand-header tracking-tight leading-[1.1] mb-8">
                ...
                <p className="text-xl font-light text-brand-header/80 leading-relaxed mt-12 max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 relative">
                ...
                <div className="space-y-6 text-brand-header/80 font-light text-[17px] leading-relaxed md:pr-4">
                  <div className="flex items-center gap-4 mb-8">
                    <div className="w-12 h-12 rounded-full bg-brand-moss/10 flex items-center justify-center border border-brand-moss/20">
                      <div className="w-3 h-3 bg-brand-moss rounded-full"></div>
                    </div>
                    <h4 className="font-serif text-3xl text-brand-header">Ease of Travel</h4>
                  </div>
                  <p>
                ...
                <div className="space-y-6 text-brand-header/80 font-light text-[17px] leading-relaxed md:pl-4">
                  <div className="flex items-center gap-4 mb-8">
                    <div className="w-12 h-12 rounded-full bg-brand-highlight/10 flex items-center justify-center border border-brand-highlight/20">
                      <div className="w-3 h-3 bg-brand-highlight rounded-full"></div>
                    </div>
                    <h4 className="font-serif text-3xl text-brand-header">Good to Know</h4>
                  </div>
                  <p>
        ...
        <section className="py-24 relative bg-gradient-to-b from-white to-brand-accent/40 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none">
            <div className="absolute -top-[20%] -right-[10%] w-[100%] h-[60%] rounded-full bg-brand-sand/6 blur-3xl" />
            <div className="absolute -top-[20%] -left-[10%] w-[100%] h-[60%] rounded-full bg-brand-sand/6 blur-3xl" />
            <div className="absolute -bottom-[20%] -right-[10%] w-[100%] h-[60%] rounded-full bg-brand-moss/6 blur-3xl" />
            <div className="absolute -bottom-[20%] -left-[10%] w-[100%] h-[60%] rounded-full bg-brand-moss/6 blur-3xl" />
          </div>
          <div className="container-custom relative z-10">
